    ...
    function(d,w,n,j,i,p,m){
        ...
        switch(n.search.replace(/[&?]Template=([^&]*)(&.*)?/,'$1')){
            ...
            case 'idg_key':
                while(++j-4){
                    t=f.item(j);
                    c=t.parentNode.parentNode.getElementsByTagName('th')[0].innerHTML;
...
(document,window,location,0,'24B30644','8564tnsf',['SASIPMQUSK','XAOKBESHQD','GRXHMVECGD','RDGUYXWYJZ','TAXWNRUKDC','TUAWQMFJWD','HYRIMFSVMO']);
